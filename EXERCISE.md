...
In this exercise you're asked to implement a frontend application.

> This application must be fully functional and deployed. Please provide a live link and include screenshots in your README.
...
Build a page that displays a list of Pokémon. Use [this](https://pokeapi.co/) API as the data source.

Each Pokémon should be presented as a card in a list/grid layout.

The page must support filtering capabilities.

---

## 2. Pokémon Detail Page

When a user clicks on a Pokémon card, they should be navigated to a detail view that displays additional information about that Pokémon.
