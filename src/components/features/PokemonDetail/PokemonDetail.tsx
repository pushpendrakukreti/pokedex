...
/**
 * PokemonDetail component - displays detailed information about a single Pokemon.
 * Uses memoization for computed values to optimize performance.
 */
                ...
                <div className="space-y-2">
                  {formattedStats.map((stat) => (
                    <div key={stat.name} className="flex items-center">
                      <span className="w-20 text-sm text-gray-600">{stat.name}</span>
                      <span className="w-10 text-sm font-medium text-gray-800">{stat.value}</span>
